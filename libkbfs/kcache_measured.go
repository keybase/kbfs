...
// KeyCacheMeasured.
func (b KeyCacheMeasured) GetTLFCryptKey(tlfID TlfID, keyGen KeyGen) (key kbfscrypto.TLFCryptKey, err error) {
...
// KeyCacheMeasured.
func (b KeyCacheMeasured) PutTLFCryptKey(tlfID TlfID, keyGen KeyGen, key kbfscrypto.TLFCryptKey) (err error) {
