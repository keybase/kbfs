...
func (md *RootMetadata) MakeSuccessor(
	...
	crypto cryptoPure, keyManager KeyManager, mdID tlf.MdID, isWriter bool) (
	*RootMetadata, error) {
...
func (md *RootMetadata) PrevRoot() tlf.MdID {
...
func (md *RootMetadata) SetPrevRoot(mdID tlf.MdID) {
...
func (md ReadOnlyRootMetadata) CheckValidSuccessor(
	currID tlf.MdID, nextMd ReadOnlyRootMetadata) error {
...
func MakeImmutableRootMetadata(
	...
	mdID tlf.MdID, localTimestamp time.Time) ImmutableRootMetadata {
...
// object.
func (irmd ImmutableRootMetadata) MdID() tlf.MdID {
	return irmd.mdID
}
