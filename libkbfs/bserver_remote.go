...
func (b *BlockServerRemote) Get(ctx context.Context, tlfID tlf.TlfID, id BlockID,
...
func (b *BlockServerRemote) Put(ctx context.Context, tlfID tlf.TlfID, id BlockID,
...
func (b *BlockServerRemote) AddBlockReference(ctx context.Context, tlfID tlf.TlfID,
...
func (b *BlockServerRemote) RemoveBlockReferences(ctx context.Context,
	tlfID tlf.TlfID, contexts map[BlockID][]BlockContext) (liveCounts map[BlockID]int, err error) {
	defer func() {
		if err != nil {
...
func (b *BlockServerRemote) batchDowngradeReferences(ctx context.Context,
	tlfID tlf.TlfID, contexts map[BlockID][]BlockContext, archive bool) (
