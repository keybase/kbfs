...
func (md *BareRootMetadataV3) MakeBareTlfHandle(rkb *TLFReaderKeyBundle, wkb *TLFWriterKeyBundleV2) (
	BareTlfHandle, error) {
...
func (md *BareRootMetadataV3) GetDeviceKIDs(
	keyGen KeyGen, user keybase1.UID, rkb *TLFReaderKeyBundle, wkb *TLFWriterKeyBundleV2) (
	[]keybase1.KID, error) {
	if rkb == nil {
...
func (md *BareRootMetadataV3) IsValidAndSigned(
	codec Codec, crypto cryptoPure, rkb *TLFReaderKeyBundle, wkb *TLFWriterKeyBundleV2) error {
	...
	handle, err := md.MakeBareTlfHandle(rkb, wkb)
	if err != nil {
		return err
	}
