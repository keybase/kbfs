...
func (md *MDServerMemory) checkGetParams(
	...
	if mStatus == Merged && bid != NullBranchID {
		return NullBranchID, tlf.MDServerErrorBadRequest{Reason: "Invalid branch ID"}
	}
	...
	if mergedMasterHead != nil {
		...
		if !ok {
			return NullBranchID, tlf.MDServerErrorUnauthorized{}
		}
	}
...
func (md *MDServerMemory) Put(ctx context.Context, rmds *RootMetadataSigned,
	...
	if err != nil {
		return tlf.MDServerErrorBadRequest{Reason: err.Error()}
	}
...
func (md *MDServerMemory) PruneBranch(ctx context.Context, id tlf.ID, bid BranchID) error {
	...
	if bid == NullBranchID {
		return tlf.MDServerErrorBadRequest{Reason: "Invalid branch ID"}
	}
...
func (md *MDServerMemory) GetKeyBundles(ctx context.Context,
	...
	*TLFWriterKeyBundleV3, *TLFReaderKeyBundleV3, error) {
	...
	if err != nil {
		return nil, nil, tlf.MDServerError{Err: err}
	}
	return wkb, rkb, nil
}
