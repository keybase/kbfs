...
func (b *BlockOpsStandard) Get(ctx context.Context, md ConstRootMetadata,
...
func (b *BlockOpsStandard) Ready(ctx context.Context, md ConstRootMetadata,
...
func (b *BlockOpsStandard) Put(ctx context.Context, md ConstRootMetadata,
...
func (b *BlockOpsStandard) Delete(ctx context.Context, md ConstRootMetadata,
...
func (b *BlockOpsStandard) Archive(ctx context.Context, md ConstRootMetadata,
