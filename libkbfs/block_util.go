...
func putBlockToServer(ctx context.Context, bserv BlockServer, tlfID tlf.TlfID,
...
func putBlockCheckQuota(ctx context.Context, bserv BlockServer,
	reporter Reporter, tlfID tlf.TlfID, blockPtr BlockPointer,
...
func doOneBlockPut(ctx context.Context, bserv BlockServer, reporter Reporter,
	tlfID tlf.TlfID, tlfName CanonicalTlfName, blockState blockState,
...
func doBlockPuts(ctx context.Context, bserv BlockServer, bcache BlockCache,
	reporter Reporter, log logger.Logger, tlfID tlf.TlfID, tlfName CanonicalTlfName,
