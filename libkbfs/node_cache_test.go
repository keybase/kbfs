...
func setupNodeCache(t *testing.T, id tlf.TlfID, branch BranchName, flat bool) (
...
func TestNodeCacheGetOrCreateSuccess(t *testing.T) {
	ncs, parentNode, childNode1A, _, path1, path2 :=
		setupNodeCache(t, tlf.FakeTlfID(0, false), MasterBranch, true)
...
func TestNodeCacheGetOrCreateNoParent(t *testing.T) {
	ncs := newNodeCacheStandard(FolderBranch{tlf.FakeTlfID(0, false), ""})
...
func checkNodeCachePath(t *testing.T, id tlf.TlfID, branch BranchName,
