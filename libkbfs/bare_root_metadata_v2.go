...
func (md *BareRootMetadataV2) CheckValidSuccessor(
	currID tlf.MdID, nextMd BareRootMetadata) error {
...
func (md *BareRootMetadataV2) GetPrevRoot() tlf.MdID {
	return md.PrevRoot
}
...
func (md *BareRootMetadataV2) SetPrevRoot(mdID tlf.MdID) {
	md.PrevRoot = mdID
}
