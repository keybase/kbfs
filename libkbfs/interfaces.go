...
type MDCache interface {
	...
	Get(tlf tlf.ID, rev tlf.MetadataRevision, bid BranchID) (ImmutableRootMetadata, error)
	...
	Delete(tlf tlf.ID, rev tlf.MetadataRevision, bid BranchID)
...
type MDOps interface {
	...
	GetRange(ctx context.Context, id tlf.ID, start, stop tlf.MetadataRevision) (
		[]ImmutableRootMetadata, error)
	...
	GetUnmergedRange(ctx context.Context, id tlf.ID, bid BranchID,
		start, stop tlf.MetadataRevision) ([]ImmutableRootMetadata, error)
...
type mdServerLocal interface {
	...
	getCurrentMergedHeadRevision(ctx context.Context, id tlf.ID) (
		rev tlf.MetadataRevision, err error)
	isShutdown() bool
...
type BareRootMetadata interface {
	...
	RevisionNumber() tlf.MetadataRevision
...
type MutableBareRootMetadata interface {
	...
	SetRevision(revision tlf.MetadataRevision)
