...
func (b BlockServerMeasured) Get(ctx context.Context, tlfID tlf.TlfID, id BlockID,
...
func (b BlockServerMeasured) Put(ctx context.Context, tlfID tlf.TlfID, id BlockID,
...
// BlockServerMeasured.
func (b BlockServerMeasured) AddBlockReference(ctx context.Context, tlfID tlf.TlfID,
