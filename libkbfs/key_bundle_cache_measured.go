...
func (b KeyBundleCacheMeasured) GetTLFReaderKeyBundle(
	tlfID tlf.TlfID, bundleID TLFReaderKeyBundleID) (rkb *TLFReaderKeyBundleV3, err error) {
...
func (b KeyBundleCacheMeasured) GetTLFWriterKeyBundle(
	tlfID tlf.TlfID, bundleID TLFWriterKeyBundleID) (wkb *TLFWriterKeyBundleV3, err error) {
...
func (b KeyBundleCacheMeasured) PutTLFReaderKeyBundle(
	tlfID tlf.TlfID, bundleID TLFReaderKeyBundleID, rkb *TLFReaderKeyBundleV3) {
...
func (b KeyBundleCacheMeasured) PutTLFWriterKeyBundle(
	tlfID tlf.TlfID, bundleID TLFWriterKeyBundleID, wkb *TLFWriterKeyBundleV3) {
