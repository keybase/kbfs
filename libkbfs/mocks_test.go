...
func (_m *MockcryptoSigner) SignForKBFS(_param0 context.Context, _param1 []byte) (kbfscrypto.SignatureInfo, error) {
...
func (_mr *_MockcryptoSignerRecorder) SignForKBFS(arg0, arg1 interface{}) *gomock.Call {
