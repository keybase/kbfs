...
func (_m *MockCodec) RegisterType(rt reflect.Type, code kbfscodec.ExtCode) {
...
func (_m *MockCodec) RegisterIfaceSliceType(rt reflect.Type, code kbfscodec.ExtCode, typer func(interface{}) reflect.Value) {
