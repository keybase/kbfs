...
func (m *MockMDServer) GetKeyBundles(ctx context.Context, tlfID tlf.ID, wkbID TLFWriterKeyBundleID, rkbID kbfsmd.TLFReaderKeyBundleID) (*TLFWriterKeyBundleV3, *kbfsmd.TLFReaderKeyBundleV3, error) {
...
// GetKeyBundles mocks base method
func (m *MockmdServerLocal) GetKeyBundles(ctx context.Context, tlfID tlf.ID, wkbID TLFWriterKeyBundleID, rkbID kbfsmd.TLFReaderKeyBundleID) (*TLFWriterKeyBundleV3, *kbfsmd.TLFReaderKeyBundleV3, error) {
	ret := m.ctrl.Call(m, "GetKeyBundles", ctx, tlfID, wkbID, rkbID)
	ret0, _ := ret[0].(*TLFWriterKeyBundleV3)
	ret1, _ := ret[1].(*kbfsmd.TLFReaderKeyBundleV3)
	ret2, _ := ret[2].(error)
