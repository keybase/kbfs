...
func (verifyingKeyType) decode(codec *kbfscodec.CodecMsgpack, data []byte) (interface{}, error) {
	k := VerifyingKey{}
...
func (cryptPublicKeyType) decode(codec *kbfscodec.CodecMsgpack, data []byte) (interface{}, error) {
	k := CryptPublicKey{}
	err := codec.Decode(data, &k)
	return k, err
}
