...
type IFCERFTEncryptedTLFCryptKeyClientHalf IFCERFTEncryptedDat

// EncryptedPrivateMetadata is an encrypted PrivateMetadata object.
type IFCERFTEncryptedPrivateMetadata IFCERFTEncryptedDat

// EncryptedBlock is an encrypted Block.
type IFCERFTEncryptedBlock IFCERFTEncryptedDat
...
const (
	...
	// considered valid.
	IFCERFTFirstValidDataVer = 1
	// FilesWithHolesDataVer is the data version for files
	// with holes.
	IFCERFTFilesWithHolesDataVer = 2
)
...
func (c IFCERFTBlockContext) IsFirstRef() bool {
	return c.RefNonce == IFCERFTZeroBlockRefNonce
}
...
func (c IFCERFTBlockContext) String() string {
	...
	if c.RefNonce != IFCERFTZeroBlockRefNonce {
...
type IFCERFTEncryptedDat struct {
...
var IFCERFTZeroBlockRefNonce = IFCERFTBlockRefNonce([8]byte{0, 0, 0, 0, 0, 0, 0, 0})
...
func (r IFCERFTBlockRef) IsValid() bool {
	return r.id.IsValid()
}

func (r IFCERFTBlockRef) String() string {
	s := fmt.Sprintf("blockRef{id: %s", r.id)
	if r.refNonce != IFCERFTZeroBlockRefNonce {
...
type IFCERFTPathNode struct {
	IFCERFTBlockPointer
	Name string
}

func (n IFCERFTPathNode) IsValid() bool {
	return n.IFCERFTBlockPointer.IsValid()
}

// DebugString returns a string representation of the node with all
// pointer information.
func (n IFCERFTPathNode) DebugString() string {
...
// root).
func (p IFCERFTPath) IsValid() bool {
	if len(p.path) < 1 {
		return false
	}
...
func (p IFCERFTPath) HasValidParent() bool {
...
func (p IFCERFTPath) TailName() string {
...
func (p IFCERFTPath) TailPointer() IFCERFTBlockPointer {
...
func (p IFCERFTPath) DebugString() string {
...
func (p IFCERFTPath) String() string {
...
// invalid path.
func (p IFCERFTPath) ParentPath() *IFCERFTPath {
	return &IFCERFTPath{p.IFCERFTFolderBranch, p.path[:len(p.path)-1]}
}

// ChildPath returns a new Path with the addition of a new entry
// with the given name and BlockPointer.
func (p IFCERFTPath) ChildPath(name string, ptr IFCERFTBlockPointer) IFCERFTPath {
	child := IFCERFTPath{
		IFCERFTFolderBranch: p.IFCERFTFolderBranch,
		path:                make([]IFCERFTPathNode, len(p.path), len(p.path)+1),
	}
	copy(child.path, p.path)
	child.path = append(child.path, IFCERFTPathNode{Name: name, IFCERFTBlockPointer: ptr})
	return child
}
...
func (p IFCERFTPath) ChildPathNoPtr(name string) IFCERFTPath {
...
func (p IFCERFTPath) HasPublic() bool {
...
type AddBPSize struct {
	...
	Ops IFCERFTOpsList `codec:"o,omitempty"`
...
// operation level.
func (bc AddBPSize) Equals(other AddBPSize) bool {
...
func (bc *AddBPSize) AddRefBlock(ptr IFCERFTBlockPointer) {
...
// and updates the size estimate.
func (bc *AddBPSize) AddUnrefBlock(ptr IFCERFTBlockPointer) {
...
// and updates the size estimate.
func (bc *AddBPSize) AddUpdate(oldPtr IFCERFTBlockPointer, newPtr IFCERFTBlockPointer) {
...
func (bc *AddBPSize) AddOp(o IFCERFTOps) {
...
type IFCERFTExtCode uint64

// these track the start of a range of unique extCodes for various
// types of extensions.
const (
	IFCERFTExtCodeOpsRangeStart  = 1
	IFCERFTExtCodeListRangeStart = 101
)
