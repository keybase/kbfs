...
func addFakeRMDSData(rmds *RootMetadataSigned, h *TlfHandle) {
	...
	if !h.IsPublic() {
		FakeInitialRekey(&rmds.MD, h.GetBareHandleOrBust())
	}
}
...
func newRMDS(t *testing.T, config Config, public bool) *RootMetadataSigned {
	...
	err := updateNewRootMetadata(&rmds.MD, id, h.GetBareHandleOrBust())
	if err != nil {
		t.Fatal(err)
	}
...
func TestMDOpsGetForHandlePublicSuccess(t *testing.T) {
	...
	config.mockMdserv.EXPECT().GetForHandle(ctx, h.GetBareHandleOrBust(), Merged).Return(NullTlfID, rmds, nil)
...
func TestMDOpsGetForUnresolvedHandlePublicSuccess(t *testing.T) {
	...
	config.mockMdserv.EXPECT().GetForHandle(ctx, hUnresolved.GetBareHandleOrBust(), Merged).Return(NullTlfID, rmds, nil).Times(2)
...
func TestMDOpsGetForUnresolvedMdHandlePublicSuccess(t *testing.T) {
	...
	config.mockMdserv.EXPECT().GetForHandle(ctx, hResolved.GetBareHandleOrBust(), Merged).Return(NullTlfID, rmds, nil).Times(2)
...
func TestMDOpsGetForUnresolvedHandlePublicFailure(t *testing.T) {
	...
	config.mockMdserv.EXPECT().GetForHandle(ctx, hUnresolved.GetBareHandleOrBust(), Merged).Return(NullTlfID, rmds, nil)
...
func TestMDOpsGetForHandleFailGet(t *testing.T) {
	...
	config.mockMdserv.EXPECT().GetForHandle(ctx, h.GetBareHandleOrBust(), Merged).Return(NullTlfID, nil, err)
...
func TestMDOpsGetForHandleFailHandleCheck(t *testing.T) {
	...
	config.mockMdserv.EXPECT().GetForHandle(ctx, otherH.GetBareHandleOrBust(), Merged).Return(NullTlfID, rmds, nil)
...
func TestMDOpsPutPublicSuccess(t *testing.T) {
	...
	err := updateNewRootMetadata(&rmd, id, h.GetBareHandleOrBust())
	require.NoError(t, err)
