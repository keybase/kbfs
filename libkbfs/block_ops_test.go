...
func TestBlockOpsGetSuccess(t *testing.T) {
	...
	err := config.BlockOps().Get(ctx, ConstRootMetadata{rmd}, blockPtr, &gotBlock)
	if err != nil {
...
func TestBlockOpsGetFailGet(t *testing.T) {
	...
	if err2 := config.BlockOps().Get(ctx, ConstRootMetadata{rmd}, blockPtr, nil); err2 != err {
...
func TestBlockOpsReadySuccess(t *testing.T) {
	...
	id2, plainSize, readyBlockData, err :=
		config.BlockOps().Ready(ctx, ConstRootMetadata{rmd}, decData)
	if err != nil {
...
func TestBlockOpsReadyFailTooLowByteCount(t *testing.T) {
	...
	_, _, _, err := config.BlockOps().Ready(ctx, ConstRootMetadata{rmd}, decData)
...
func TestBlockOpsReadyFailEncryptBlockData(t *testing.T) {
	...
	if _, _, _, err2 := config.BlockOps().
		Ready(ctx, ConstRootMetadata{rmd}, decData); err2 != err {
...
func TestBlockOpsPutNewBlockSuccess(t *testing.T) {
	...
	if err := config.BlockOps().
		Put(ctx, ConstRootMetadata{rmd}, blockPtr, readyBlockData); err != nil {
...
func TestBlockOpsPutFail(t *testing.T) {
	...
	if err2 := config.BlockOps().
		Put(ctx, ConstRootMetadata{rmd}, blockPtr, readyBlockData); err2 != err {
...
func TestBlockOpsDeleteSuccess(t *testing.T) {
	...
	if _, err := config.BlockOps().Delete(ctx, ConstRootMetadata{rmd}, blockPtrs); err != nil {
...
func TestBlockOpsDeleteFail(t *testing.T) {
	...
	if _, err2 := config.BlockOps().Delete(ctx, ConstRootMetadata{rmd}, blockPtrs); err2 != err {
