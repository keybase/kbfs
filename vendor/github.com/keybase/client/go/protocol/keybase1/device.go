...
func (o DeviceHistoryListArg) DeepCopy() DeviceHistoryListArg {
	return DeviceHistoryListArg{
		SessionID: o.SessionID,
	}
}
...
func (o CheckDeviceNameFormatArg) DeepCopy() CheckDeviceNameFormatArg {
	return CheckDeviceNameFormatArg{
		SessionID: o.SessionID,
		Name:      o.Name,
	}
}
...
func (o CheckDeviceNameForUserArg) DeepCopy() CheckDeviceNameForUserArg {
	return CheckDeviceNameForUserArg{
		SessionID:  o.SessionID,
		Username:   o.Username,
