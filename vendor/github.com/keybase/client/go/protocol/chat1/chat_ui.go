...
func (c ChatUiClient) ChatAttachmentDownloadStart(ctx context.Context, sessionID int) (err error) {
	...
	err = c.Cli.CallCompressed(ctx, "chat.1.chatUi.chatAttachmentDownloadStart", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c ChatUiClient) ChatAttachmentDownloadDone(ctx context.Context, sessionID int) (err error) {
	...
	err = c.Cli.CallCompressed(ctx, "chat.1.chatUi.chatAttachmentDownloadDone", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c ChatUiClient) ChatInboxUnverified(ctx context.Context, __arg ChatInboxUnverifiedArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "chat.1.chatUi.chatInboxUnverified", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c ChatUiClient) ChatInboxConversation(ctx context.Context, __arg ChatInboxConversationArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "chat.1.chatUi.chatInboxConversation", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c ChatUiClient) ChatInboxFailed(ctx context.Context, __arg ChatInboxFailedArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "chat.1.chatUi.chatInboxFailed", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}
...
func (c ChatUiClient) ChatSearchHit(ctx context.Context, __arg ChatSearchHitArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "chat.1.chatUi.chatSearchHit", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c ChatUiClient) ChatSearchDone(ctx context.Context, __arg ChatSearchDoneArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "chat.1.chatUi.chatSearchDone", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c ChatUiClient) ChatSearchInboxHit(ctx context.Context, __arg ChatSearchInboxHitArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "chat.1.chatUi.chatSearchInboxHit", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c ChatUiClient) ChatSearchInboxDone(ctx context.Context, __arg ChatSearchInboxDoneArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "chat.1.chatUi.chatSearchInboxDone", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c ChatUiClient) ChatSearchIndexStatus(ctx context.Context, __arg ChatSearchIndexStatusArg) (err error) {
	err = c.Cli.CallCompressed(ctx, "chat.1.chatUi.chatSearchIndexStatus", []interface{}{__arg}, nil, rpc.CompressionNone)
	return
}

func (c ChatUiClient) ChatConfirmChannelDelete(ctx context.Context, __arg ChatConfirmChannelDeleteArg) (res bool, err error) {
	err = c.Cli.CallCompressed(ctx, "chat.1.chatUi.chatConfirmChannelDelete", []interface{}{__arg}, &res, rpc.CompressionNone)
	return
}
