...
// bob makes a file in a dir that alice has removed and recreated.
func TestCrUnmergedCreateInARemadeDir(t *testing.T) {
	test(t,
		users("alice", "bob"),
		as(alice,
			mkdir("a/b"),
...
// alice makes a file in a dir that bob has removed and recreated.
func TestCrMergedCreateInARemadeDir(t *testing.T) {
	test(t,
		users("alice", "bob"),
		as(alice,
			mkdir("a/b"),
