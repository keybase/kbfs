...
// WriteFile implements writes for cbfs. Note a write triggers quota
// reclamation, but does not wait for it to finish. If you want to
// wait, write to SyncFromServerFileName.
func (f *ReclaimQuotaFile) WriteFile(ctx context.Context, bs []byte, offset int64) (n int, err error) {
