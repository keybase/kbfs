...
// GetFileInformation does stats for cbfs.
func (f *SpecialReadFile) GetFileInformation(ctx context.Context) (*cbfs.Stat, error) {
	...
	a.FileAttributes |= cbfs.FileAttributeReadonly
...
// ReadFile does reads for cbfs.
func (f *SpecialReadFile) ReadFile(ctx context.Context, bs []byte, offset int64) (int, error) {
