...
// Attr implements the fs.Node interface for SpecialReadBlockingFile.
func (f *SpecialReadBlockingFile) Attr(
...
var _ fs.Handle = (*SpecialReadBlockingFile)(nil)

var _ fs.NodeOpener = (*SpecialReadBlockingFile)(nil)
