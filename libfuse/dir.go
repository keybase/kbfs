...
func (d *Dir) Access(ctx context.Context, r *fuse.AccessRequest) (err error) {
	ctx = d.folder.fs.maybeStartTrace(ctx, "Dir.Access", d.node.GetBasename())
...
func (d *Dir) Attr(ctx context.Context, a *fuse.Attr) (err error) {
	ctx = d.folder.fs.maybeStartTrace(ctx, "Dir.Attr", d.node.GetBasename())
	defer func() { d.folder.fs.maybeFinishTrace(ctx, err) }()
...
func (d *Dir) Lookup(ctx context.Context, req *fuse.LookupRequest, resp *fuse.LookupResponse) (node fs.Node, err error) {
	ctx = d.folder.fs.maybeStartTrace(ctx, "Dir.Lookup", d.node.GetBasename())
	defer func() { d.folder.fs.maybeFinishTrace(ctx, err) }()
...
func (d *Dir) Create(ctx context.Context, req *fuse.CreateRequest, resp *fuse.CreateResponse) (node fs.Node, handle fs.Handle, err error) {
	ctx = d.folder.fs.maybeStartTrace(ctx, "Dir.Create", d.node.GetBasename()+" "+req.Name)
	defer func() { d.folder.fs.maybeFinishTrace(ctx, err) }()
...
func (d *Dir) Mkdir(ctx context.Context, req *fuse.MkdirRequest) (
	...
	ctx = d.folder.fs.maybeStartTrace(ctx, "Dir.Mkdir", d.node.GetBasename()+" "+req.Name)
	defer func() { d.folder.fs.maybeFinishTrace(ctx, err) }()
...
func (d *Dir) Symlink(ctx context.Context, req *fuse.SymlinkRequest) (
	node fs.Node, err error) {
	ctx = d.folder.fs.maybeStartTrace(ctx, "Dir.Symlink", d.node.GetBasename()+" "+req.NewName+" -> "+req.Target)
	defer func() { d.folder.fs.maybeFinishTrace(ctx, err) }()
...
func (d *Dir) Rename(ctx context.Context, req *fuse.RenameRequest,
	...
	ctx = d.folder.fs.maybeStartTrace(ctx, "Dir.Rename", d.node.GetBasename()+" "+req.OldName+" -> "+req.NewName)
	defer func() { d.folder.fs.maybeFinishTrace(ctx, err) }()
...
func (d *Dir) Remove(ctx context.Context, req *fuse.RemoveRequest) (err error) {
	ctx = d.folder.fs.maybeStartTrace(ctx, "Dir.Remove", d.node.GetBasename()+" "+req.Name)
	defer func() { d.folder.fs.maybeFinishTrace(ctx, err) }()
...
func (d *Dir) ReadDirAll(ctx context.Context) (res []fuse.Dirent, err error) {
	ctx = d.folder.fs.maybeStartTrace(ctx, "Dir.ReadDirAll", d.node.GetBasename())
	defer func() { d.folder.fs.maybeFinishTrace(ctx, err) }()
...
func (d *Dir) Setattr(ctx context.Context, req *fuse.SetattrRequest, resp *fuse.SetattrResponse) (err error) {
	ctx = d.folder.fs.maybeStartTrace(ctx, "Dir.Setattr", d.node.GetBasename())
	defer func() { d.folder.fs.maybeFinishTrace(ctx, err) }()
